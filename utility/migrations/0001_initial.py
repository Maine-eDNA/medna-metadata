    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project_research_questions', models.TextField(blank=True, verbose_name='Project Research Questions')),
                ('grant_names', models.ManyToManyField(on_delete=django.db.models.deletion.RESTRICT, to='utility.grant', verbose_name="Affiliated Grant(s)", related_name="grant_names")),
                ('created_by', models.ForeignKey(default=utility.models.get_default_user, on_delete=models.SET(utility.models.get_sentinel_user), to=settings.AUTH_USER_MODEL)),
                ('modified_datetime', models.DateTimeField(auto_now_add=True, verbose_name='Modified DateTime')),
                ('created_datetime', models.DateTimeField(auto_now=True, verbose_name='Created DateTime')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project_names', models.ManyToManyField(on_delete=django.db.models.deletion.RESTRICT, to='utility.grant', verbose_name="Affiliated Grant(s)", related_name="grant_names")),
                ('publication_authors', models.ManyToManyField(on_delete=django.db.models.deletion.RESTRICT, to=settings.AUTH_USER_MODEL, verbose_name="Affiliated Authors(s)", related_name="publication_authors")),
