    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sop_type', models.CharField(choices=[(None, '(Unknown)'), ('bioinformatics', 'Bioinformatics'), ('wet_lab', 'Wet Lab'), ('field_collection', 'Field Collection'), ('freezer_inventory', 'Freezer Inventory')], max_length=50, verbose_name='SOP Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('template_type', models.CharField(choices=[(None, '(Unknown)'), ('bioinformatics', 'Bioinformatics'), ('wet_lab', 'Wet Lab'), ('field_collection', 'Field Collection'), ('freezer_inventory', 'Freezer Inventory')], max_length=50, verbose_name='Template Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('defined_term_module', models.CharField(blank=True, choices=[(None, '(Unknown)'), ('bioinformatics', 'Bioinformatics'), ('wet_lab', 'Wet Lab'), ('field_collection', 'Field Collection'), ('freezer_inventory', 'Freezer Inventory')], max_length=50, verbose_name='Related Module (Optional)')),
