...
class LibPrepKits(models.TextChoices):
    ...
    TRUSEQDNARNACD96 = 'truseq_dna_rna_cd_indexes_96_indexes', _('TruSeq DNA-RNA CD Indexes 96 Indexes')
    TRUSEQDNARNASINGLEAB = '12s', _('TruSeq DNA-RNA Single Indexes Set A&B')
    TRUSEQMETHEPIC = '12s', _('TruSeq Methyl Capture EPIC')
    TRUSEQRIBOPROFIL = '12s', _('TruSeq Ribo Profil')
    TRUSEQSMALLRNA = '12s', _('TruSeq Small RNA')
    TRUSEQTRGTEDRNAEXPR = '12s', _('TruSeq Targeted RNA Expression')
    TRUSIGHTAMPLICONPANEL = '12s', _('TruSight Amplicon Panels')
    TRUSIGHTENRICHMENTPANEL = '12s', _('TruSight Enrichment Panels')
    TRUSIGHTRNAFUSION = '12s', _('TruSight RNA Fusion')
    TRUSIGHTTUMOR15 = '12s', _('TruSight Tumor 15')
    TRUSIGHTTUMOR126 = '12s', _('TruSight Tumor 126')
    AMPLISEQLIBPLUS96 = '12s', _('AmpliSeq Library PLUS for Illumina (96)')
    CUSTOM = '12s', _('Custom')
    __empty__ = _('(Unknown)')
