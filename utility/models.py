...
class ProcessLocation(DateTimeUserMixin):
    ...
    location_email_address = models.EmailField(_('Location Email Address', null=True))
    point_of_contact_email_address = models.EmailField(_('Point of Contact Email Address', null=True))
