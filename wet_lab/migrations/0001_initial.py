    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('index_removal_sop', models.ForeignKey(to='utility.standardoperatingprocedure', on_delete=django.db.models.deletion.RESTRICT, verbose_name='Index Removal SOP')),
                ('modified_datetime', models.DateTimeField(auto_now_add=True, verbose_name='Modified DateTime')),
                ('created_datetime', models.DateTimeField(auto_now=True, verbose_name='Created DateTime')),
                ('created_by', models.ForeignKey(default=utility.models.get_default_user, on_delete=models.SET(utility.models.get_sentinel_user), to=settings.AUTH_USER_MODEL)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('primer_set', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, to='wet_lab.primerpair')),
                ('size_selection_sop', models.ForeignKey(to='utility.standardoperatingprocedure', on_delete=django.db.models.deletion.RESTRICT, verbose_name='Size Selection SOP')),
                ('modified_datetime', models.DateTimeField(auto_now_add=True, verbose_name='Modified DateTime')),
                ('created_datetime', models.DateTimeField(auto_now=True, verbose_name='Created DateTime')),
                ('created_by', models.ForeignKey(default=utility.models.get_default_user, on_delete=models.SET(utility.models.get_sentinel_user), to=settings.AUTH_USER_MODEL)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amplification_sop', models.ForeignKey(to='utility.standardoperatingprocedure', on_delete=django.db.models.deletion.RESTRICT, verbose_name='Amplification SOP')),
                ('modified_datetime', models.DateTimeField(auto_now_add=True, verbose_name='Modified DateTime')),
                ('created_datetime', models.DateTimeField(auto_now=True, verbose_name='Created DateTime')),
                ('created_by', models.ForeignKey(default=utility.models.get_default_user, on_delete=models.SET(utility.models.get_sentinel_user), to=settings.AUTH_USER_MODEL)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extraction_sop', models.ForeignKey(to='utility.standardoperatingprocedure', on_delete=django.db.models.deletion.RESTRICT, verbose_name='Extraction SOP')),
                ('modified_datetime', models.DateTimeField(auto_now_add=True, verbose_name='Modified DateTime')),
                ('created_datetime', models.DateTimeField(auto_now=True, verbose_name='Created DateTime')),
                ('created_by', models.ForeignKey(default=utility.models.get_default_user, on_delete=models.SET(utility.models.get_sentinel_user), to=settings.AUTH_USER_MODEL)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pcr_sop', models.ForeignKey(to='utility.standardoperatingprocedure', on_delete=django.db.models.deletion.RESTRICT, verbose_name='PCR SOP')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lib_prep_sop', models.ForeignKey(to='utility.standardoperatingprocedure', on_delete=django.db.models.deletion.RESTRICT, verbose_name='Library Prep SOP')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extraction', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, to='wet_lab.extraction', related_name='extractions')),
                ('primer_set', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, to='wet_lab.primerpair', related_name='primer_sets')),
                ('fastq_slug', models.SlugField(max_length=255, verbose_name='Fastq Slug')),
                ('fastq_datafile', models.FileField(max_length=255, storage=medna_metadata.storage_backends.select_private_sequencing_storage, upload_to='', verbose_name='FastQ Datafile')),
