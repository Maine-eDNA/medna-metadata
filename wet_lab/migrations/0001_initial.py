    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('index_removal_method_name',
                 models.CharField(max_length=255, unique=True, verbose_name='Index Removal Method')),
                ('index_removal_method_name_slug',
                 models.SlugField(max_length=255, verbose_name='Index Removal Method Slug')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_datetime', models.DateTimeField(auto_now=True, verbose_name='Created DateTime')),
                ('quant_method_name',
                 models.CharField(max_length=255, unique=True, verbose_name='Quantification Method')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified_datetime', models.DateTimeField(auto_now_add=True, verbose_name='Modified DateTime')),
                ('created_datetime', models.DateTimeField(auto_now=True, verbose_name='Created DateTime')),
                ('size_selection_method_name',
                 models.CharField(max_length=255, unique=True, verbose_name='Size Selection Method')),
                ('size_selection_method_name_slug',
                 models.SlugField(max_length=255, verbose_name='Size Selection Method Slug')),
                ('created_by', models.ForeignKey(default=utility.models.get_default_user,
                                                 on_delete=models.SET(utility.models.get_sentinel_user),
                                                 to=settings.AUTH_USER_MODEL)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extraction_method_manufacturer',
                 models.CharField(max_length=255, verbose_name='Extraction Kit Manufacturer')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extraction_barcode', models.OneToOneField(limit_choices_to={'in_freezer': 'no'}, on_delete=django.db.models.deletion.RESTRICT, to='sample_labels.samplelabel')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qpcr_experiment_name',
                 models.CharField(max_length=255, unique=True, verbose_name='qPCR Experiment Name')),
                ('qpcr_experiment_name_slug',
                 models.SlugField(max_length=255, verbose_name='qPCR Experiment Name Slug')),
                ...
                ('qpcr_results_units',
                 models.CharField(choices=[(None, '(Unknown)'), ('cq', 'Quantification Cycle (Cq)')], default='cq',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ddpcr_experiment_name',
                 models.CharField(max_length=255, unique=True, verbose_name='ddPCR Experiment Name')),
                ('ddpcr_experiment_name_slug',
                 models.SlugField(max_length=255, verbose_name='ddPCR Experiment Name Slug')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pooled_lib_concentration',
                 models.DecimalField(decimal_places=10, max_digits=15, verbose_name='Pooled Library Concentration')),
                ...
                ('created_by', models.ForeignKey(default=utility.models.get_default_user,
                                                 ...
                                                 to=settings.AUTH_USER_MODEL)),
                ('library_prep',
                 models.ManyToManyField(related_name='libraryprep_to_pooledlibrary', to='wet_lab.LibraryPrep')),
                ('process_location', models.ForeignKey(default=utility.models.get_default_process_location,
                                                       on_delete=django.db.models.deletion.RESTRICT,
                                                       to='utility.processlocation')),
                ('quantification_method',
                 models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='wet_lab.quantificationmethod')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('final_pooled_lib_label',
                 models.CharField(max_length=255, unique=True, verbose_name='Final Pooled Library Label')),
                ('final_pooled_lib_label_slug',
                 models.SlugField(max_length=255, verbose_name='Final Pooled Library Label Slug')),
