    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fastq_datafile', models.FileField(max_length=255, storage=medna_metadata.storage_backends.select_private_sequencing_storage, upload_to=wet_lab.models.get_run_id_upload_subdir, verbose_name='FastQ Datafile')),                ('submitted_to_insdc', models.CharField(choices=[(None, '(Unknown)'), ('no', 'No'), ('yes', 'Yes')], default='no', max_length=3, verbose_name='Submitted to INSDC')),
