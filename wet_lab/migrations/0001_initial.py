    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('final_pooled_lib_concentration', models.DecimalField(decimal_places=10, max_digits=15, verbose_name='Final Pooled Library Concentration')),
                ('final_pooled_lib_concentration_units', models.CharField(choices=[(None, '(Unknown)'), ('nanograms_per_microliter', 'Nanograms per microliter (ng/µL)'), ('nanograms_per_milliliter', 'Nanograms per milliliter (ng/mL)'), ('picograms_per_microliter', 'Picograms per microliter (pg/µL)'), ('nanomolar', 'nanomolar (nM)'), ('picomolar', 'picomolar (pM)')], default='nanomolar', max_length=50, verbose_name='Final Pooled Library Units')),
                ('final_pooled_lib_notes', models.TextField(blank=True, verbose_name='Final Pooled Library Notes')),
                ('created_by', models.ForeignKey(default=utility.models.get_default_user, null=True, on_delete=models.SET(utility.models.get_sentinel_user), to=settings.AUTH_USER_MODEL)),
                ('final_pooled_lib_barcode', models.OneToOneField(limit_choices_to={'in_freezer': 'no'}, on_delete=django.db.models.deletion.RESTRICT, to='sample_labels.samplelabel')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qpcr_results_units', models.CharField(choices=[(None, '(Unknown)'), ('cq', 'Quantification Cycle (Cq)')], default='cq', max_length=50, verbose_name='qPCR Units')),
        ...
        migrations.AddField(
            model_name='finalpooledlibrary',
            name='pooled_library',
            field=models.ManyToManyField(related_name='pooledlibrary_to_finalpooledlibrary', to='wet_lab.PooledLibrary'),
        ),
        migrations.AddField(
            model_name='finalpooledlibrary',
            name='process_location',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='wet_lab.extractionmethod'),
        ),
        migrations.AddField(
            model_name='extraction',
            name='field_sample',
            field=models.OneToOneField(limit_choices_to={'is_extracted': 'no'}, on_delete=django.db.models.deletion.RESTRICT, to='field_survey.fieldsample'),
        ),
        migrations.AddField(
            model_name='extraction',
            name='process_location',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ddpcr_results_units', models.CharField(choices=[(None, '(Unknown)'), ('cp', 'Copy Number'), ('cp_per_microliter', 'Copies per microliter (copy/µL)')], default='cp', max_length=50, verbose_name='ddPCR Units')),
