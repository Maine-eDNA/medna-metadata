    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('seq_quality_check', models.CharField(choices=[('none', 'None'), ('manual_edit', 'Manually Edited')], default='yes', max_length=50, verbose_name='Quality Check')),
                ...
                ('quality_slug', models.SlugField(max_length=255, verbose_name='Quality Slug')),
