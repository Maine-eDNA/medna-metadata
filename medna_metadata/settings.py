...
APP_ORDER = OrderedDict([
    ...
    ('utility', ['MetadataTemplateFile', 'Fund', 'Project', 'Publication', 'ProcessLocation',
                 'StandardOperatingProcedure', 'ContactUs', 'DefaultSiteCss', 'CustomUserCss', 'PeriodicTaskRun']),
