...
APP_ORDER = OrderedDict([
    ...
    ('utility', ['Fund', 'Project', 'Publication', 'ProcessLocation',
                 'StandardOperatingProcedure', 'MetadataTemplateFile', 'DefinedTerm',
                 'ContactUs', 'DefaultSiteCss', 'CustomUserCss', 'PeriodicTaskRun']),
