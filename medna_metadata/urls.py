...
urlpatterns = [
    ...
    path('api/choices_yes_no/', YesNoChoicesAPIView.as_view(), name='choices_yes_no'),
    path('api/choices_measure_units/', MeasureUnitsChoicesAPIView.as_view(), name='choices_measure_units'),
    path('api/choices_vol_units/', VolUnitsChoicesAPIView.as_view(), name='choices_vol_units'),
    path('api/choices_concentration_units/', ConcentrationUnitsChoicesAPIView.as_view(), name='choices_concentration_units'),
    path('api/choices_phix_concentration_units/', PhiXConcentrationUnitsChoicesAPIView.as_view(), name='choices_phix_concentration_units'),
    path('api/choices_ddpcr_units/', DdpcrUnitsChoicesAPIView.as_view(), name='choices_ddpcr_units'),
    path('api/choices_qpcr_units/', QpcrUnitsChoicesAPIView.as_view(), name='choices_qpcr_units'),
    path('api/choices_wind_speeds/', WindSpeedsChoicesAPIView.as_view(), name='choices_wind_speeds'),
    path('api/choices_cloud_covers/', CloudCoversChoicesAPIView.as_view(), name='choices_cloud_covers'),
    path('api/choices_precip_types/', PrecipTypesChoicesAPIView.as_view(), name='choices_precip_types'),
    path('api/choices_turbid_types/', TurbidTypesChoicesAPIView.as_view(), name='choices_turbid_types'),
    path('api/choices_envo_materials/', EnvoMaterialsChoicesAPIView.as_view(), name='choices_envo_materials'),
    path('api/choices_measure_modes/', MeasureModesChoicesAPIView.as_view(), name='choices_measure_modes'),
    path('api/choices_env_instruments/', EnvInstrumentsChoicesAPIView.as_view(), name='choices_env_instruments'),
    path('api/choices_ysi_models/', YsiModelsChoicesAPIView.as_view(), name='choices_ysi_models'),
    path('api/choices_env_measurements/', EnvMeasurementsChoicesAPIView.as_view(), name='choices_env_measurements'),
    path('api/choices_bottom_substrates/', BottomSubstratesChoicesAPIView.as_view(), name='choices_bottom_substrates'),
    path('api/choices_water_collection_modes/', WaterCollectionModesChoicesAPIView.as_view(), name='choices_water_collection_modes'),
    path('api/choices_collection_types/', CollectionTypesChoicesAPIView.as_view(), name='choices_collection_types'),
    path('api/choices_filter_locations/', FilterLocationsChoicesAPIView.as_view(), name='choices_filter_locations'),
    path('api/choices_control_types/', ControlTypesChoicesAPIView.as_view(), name='choices_control_types'),
    path('api/choices_filter_methods/', FilterMethodsChoicesAPIView.as_view(), name='choices_filter_methods'),
    path('api/choices_filter_types/', FilterTypesChoicesAPIView.as_view(), name='choices_filter_types'),
    path('api/choices_core_methods/', CoreMethodsChoicesAPIView.as_view(), name='choices_core_methods'),
    path('api/choices_subcore_methods/', SubCoreMethodsChoicesAPIView.as_view(), name='choices_subcore_methods'),
    path('api/choices_target_genes/', TargetGenesChoicesAPIView.as_view(), name='choices_target_genes'),
    path('api/choices_lib_prep_types/', LibPrepTypesChoicesAPIView.as_view(), name='choices_lib_prep_types'),
    path('api/choices_lib_prep_kits/', LibPrepKitsChoicesAPIView.as_view(), name='choices_lib_prep_kits'),
    path('api/choices_inv_status/', InvStatusChoicesAPIView.as_view(), name='choices_inv_status'),
    path('api/choices_inv_types/', InvTypesChoicesAPIView.as_view(), name='choices_inv_types'),
    path('api/choices_checkout_actions/', CheckoutActionsChoicesAPIView.as_view(), name='choices_checkout_actions'),
]
