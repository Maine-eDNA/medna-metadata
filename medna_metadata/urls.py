...
from field_survey.views import GeoFieldSurveyViewSet, FieldCrewViewSet, EnvMeasurementViewSet, FieldCollectionViewSet, \
    ...
    FieldCollectionETLViewSet, SampleFilterETLViewSet, FieldSurveyFieldCrewNestedViewSet
...
router.register(r'field_survey/nested_field_crew', FieldSurveyFieldCrewNestedViewSet, 'nested_field_crew')
