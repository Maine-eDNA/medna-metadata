...
router.register(r'utility/metadata_template', utility_views.MetadataTemplateFileViewSet, 'metadata_template')
router.register(r'utility/defined_term', utility_views.DefinedTermViewSet, 'defined_term')
