        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(default=utility.models.get_default_user,
                                                 ...
                                                 to=settings.AUTH_USER_MODEL)),
                ('taxon_domain',
                 models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='bioinfo_taxon.taxondomain')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(default=utility.models.get_default_user,
                                                 ...
                                                 to=settings.AUTH_USER_MODEL)),
                ('taxon_class',
                 models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='bioinfo_taxon.taxonclass')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('redfb_coverage_score',
                 models.DecimalField(decimal_places=2, max_digits=6, verbose_name='Coverage Score (Percentage)')),
