...
class Freezer(DateTimeUserMixin):
    freezer_datetime = models.DateTimeField("Freezer DateTime", auto_now=True)
...
class FreezerRack(DateTimeUserMixin):
    ...
    freezer_rack_datetime = models.DateTimeField("Freezer Rack DateTime", auto_now=True)
...
class FreezerInventory(DateTimeUserMixin):
    ...
    # freezer_inventory_datetime is satisfied by created_datetime
