    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('freezer_inventory', models.ForeignKey(limit_choices_to={'freezer_inventory_loc_status': 'filled'}, on_delete=django.db.models.deletion.RESTRICT, related_name="freezer_inventory", to='freezer_inventory.freezerinventory')),
                ('created_by', models.ForeignKey(default=utility.models.get_default_user, on_delete=models.SET(utility.models.get_sentinel_user), to=settings.AUTH_USER_MODEL)),
                ('modified_datetime', models.DateTimeField(auto_now_add=True, verbose_name='Modified DateTime')),
                ('created_datetime', models.DateTimeField(auto_now=True, verbose_name='Created DateTime')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('freezer_log', models.OneToOneField(limit_choices_to={'freezer_log_action': 'return'}, on_delete=django.db.models.deletion.RESTRICT, related_name='freezer_log', primary_key=True, serialize=False, to='freezer_inventory.freezerinventorylog')),
