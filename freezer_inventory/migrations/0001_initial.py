    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('freezer_capacity_columns', models.PositiveIntegerField(verbose_name='Max Freezer Columns (Boxes)')),
                ('freezer_capacity_rows', models.PositiveIntegerField(verbose_name='Max Freezer Rows (Boxes)')),
                ('freezer_capacity_depth', models.PositiveIntegerField(verbose_name='Max Freezer Depth (Boxes)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('freezer_box_capacity_column', models.PositiveIntegerField(verbose_name='Max Box Columns (Inventory)')),
                ('freezer_box_capacity_row', models.PositiveIntegerField(verbose_name='Max Box Rows (Inventory)')),
                ('created_by', models.ForeignKey(default=utility.models.get_default_user, on_delete=models.SET(utility.models.get_sentinel_user), to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(default=utility.models.get_default_user, on_delete=models.SET(utility.models.get_sentinel_user), to=settings.AUTH_USER_MODEL)),
                ('freezer_inventory', models.ForeignKey(limit_choices_to={'freezer_inventory_loc_status': 'filled'}, on_delete=django.db.models.deletion.RESTRICT, to='freezer_inventory.freezerinventory')),
            ],
            options={
