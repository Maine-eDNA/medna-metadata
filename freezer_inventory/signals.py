...
from freezer_inventory.models import Freezer, FreezerRack, FreezerCheckout
...
@receiver(post_save, sender=FreezerCheckout, dispatch_uid="update_record_return_metadata")
