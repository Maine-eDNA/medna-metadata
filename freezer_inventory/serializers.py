...
class FreezerCheckoutSerializer(serializers.ModelSerializer):
    ...
    freezer_checkout_datetime = serializers.DateTimeField(allow_blank=True, allow_null=True)
    freezer_return_datetime = serializers.DateTimeField(allow_blank=True, allow_null=True)
    freezer_perm_removal_datetime = serializers.DateTimeField(allow_blank=True, allow_null=True)
