...
class FieldSurvey(DateTimeUserMixin):
    ...
    gps_horacc = models.DecimalField('GPS Horizontal Accuracy (m)', blank=True, null=True, max_digits=22, decimal_places=16)
    gps_vertacc = models.DecimalField('GPS Vertical Accuracy (m)', blank=True, null=True, max_digits=22, decimal_places=16)
...
class EnvMeasurement(DateTimeUserMixin):
    env_global_id = models.UUIDField(verbose_name='EnvMeas Global ID', primary_key=True, editable=False, default=uuid.uuid4)
...
class FieldCollection(DateTimeUserMixin):
    collection_global_id = models.UUIDField(verbose_name='Collection Global ID', primary_key=True, editable=False, default=uuid.uuid4)
