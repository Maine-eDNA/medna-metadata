...
class FieldSurveyAdminResource(resources.ModelResource):
    class Meta:
        ...
        import_id_fields = ('survey_global_id','username', 'survey_datetime', 'project_ids', 'supervisor',
                            ...
                            'core_subcorer', 'water_filterer', 'survey_complete', 'qa_editor', 'qa_datetime',
                            'qa_initial', 'gps_cap_lat', 'gps_cap_long', 'gps_cap_alt', 'gps_cap_horiz_acc',
                            'gps_cap_vert_acc', 'record_create_date', 'record_creator', 'record_edit_date',
                            'record_editor',)
...
class FieldCrewETLAdminResource(resources.ModelResource):
    class Meta:
        ...
        import_id_fields = ('crew_global_id', 'crew_fname', 'crew_lname', 'survey_global_id',)
        fields = ('crew_global_id', 'crew_fname', 'crew_lname', 'survey_global_id', 'created_by', 'created_datetime',)
        export_order = ('crew_global_id', 'crew_fname', 'crew_lname', 'survey_global_id', 'created_by',
                        'created_datetime',)
...
class SampleFilterETLAdminResource(resources.ModelResource):
    class Meta:
        ...
        import_id_fields = ('filter_global_id', 'field_sample_barcode', 'filter_location', 'is_prefilter',
                            'filter_fname', 'filter_lname', 'filter_sample_label', 'filter_datetime', 'filter_method',
        ...
        export_order = ('filter_global_id', 'field_sample_barcode', 'filter_location', 'is_prefilter', 'filter_fname',
                        ...
                        'filter_method_other', 'filter_vol', 'filter_type', 'filter_type_other', 'filter_pore',
                        'filter_size', 'filter_notes', 'collection_global_id', 'created_datetime', 'created_by',)
