    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('record_creator', models.ForeignKey(blank=True, null=True, on_delete=models.SET(utility.models.get_sentinel_user), related_name='survey_record_creator', to=settings.AUTH_USER_MODEL, verbose_name='Survey Creator')),
                ('record_editor', models.ForeignKey(blank=True, null=True, on_delete=models.SET(utility.models.get_sentinel_user), related_name='survey_record_editor', to=settings.AUTH_USER_MODEL, verbose_name='Survey Editor')),
