    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_extracted', models.CharField(choices=[(None, '(Unknown)'), ('no', 'No'), ('yes', 'Yes')], default='no', max_length=50, verbose_name='Extracted')),
                ...
                ('created_by', models.ForeignKey(default=utility.models.get_default_user, on_delete=models.SET(utility.models.get_sentinel_user), to=settings.AUTH_USER_MODEL)),
                ('field_sample_barcode', models.OneToOneField(on_delete=django.db.models.deletion.RESTRICT, to='sample_labels.samplelabel')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('record_creator', models.ForeignKey(blank=True, null=True, on_delete=models.SET(utility.models.get_sentinel_user), related_name='record_creator', to=settings.AUTH_USER_MODEL, verbose_name='Survey Creator')),
                ('record_editor', models.ForeignKey(blank=True, null=True, on_delete=models.SET(utility.models.get_sentinel_user), related_name='record_editor', to=settings.AUTH_USER_MODEL, verbose_name='Survey Editor')),
        ...
        migrations.AddField(
            model_name='fieldcollectionetl',
            name='survey_global_id',
            field=models.ForeignKey(db_column='survey_global_id', on_delete=django.db.models.deletion.CASCADE, related_name='fieldsurvey_to_fieldcollection_etl', to='field_survey.fieldsurveyetl'),
        ),
        migrations.AddField(
            model_name='fieldcollection',
            name='survey_global_id',
            field=models.ForeignKey(db_column='survey_global_id', on_delete=django.db.models.deletion.CASCADE, related_name='fieldsurvey_to_fieldcollection', to='field_survey.fieldsurvey'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('env_instrument', models.CharField(blank=True, max_length=255, verbose_name='Instruments Used')),
                ...
                ('env_measurement', models.CharField(blank=True, max_length=255, verbose_name='Environmental Measurements')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('env_measure_datetime', models.DateTimeField(blank=True, null=True, verbose_name='Measurement DateTime')),
                ('env_measure_depth', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True, verbose_name='Measurement Depth (m)')),
                ('env_instrument', models.CharField(blank=True, choices=[(None, '(Unknown)'), ('env_ctd', 'CTD'), ('env_ysi', 'YSI'), ('env_secchi', 'Secchi Disk'), ('env_niskin', 'Niskin'), ('env_inst_other', 'Other')], max_length=50, verbose_name='Instruments Used')),
                ('env_ctd_filename', models.CharField(blank=True, max_length=255, verbose_name='CTD File Name')),
                ('env_ctd_notes', models.TextField(blank=True, verbose_name='CTD Notes')),
                ('env_ysi_filename', models.CharField(blank=True, max_length=255, verbose_name='YSI File Name')),
                ...
                ('env_niskin_notes', models.TextField(blank=True, verbose_name='Niskin Notes')),
                ('env_inst_other', models.TextField(blank=True, verbose_name='Other Instruments')),
                ('env_measurement', models.CharField(blank=True, choices=[(None, '(Unknown)'), ('env_flow', 'Flow'), ('env_water_temp', 'Water Temp'), ('env_salinity', 'Salinity'), ('env_ph', 'pH'), ('env_par1', 'PAR1'), ('env_par2', 'PAR2'), ('env_turbidity', 'Turbidity'), ('env_conductivity', 'Cond'), ('env_do', 'DO'), ('env_pheophytin', 'Pheo'), ('env_chla', 'Chl-a'), ('env_no3no2', 'NO3NO2'), ('env_no2', 'NO2'), ('env_nh4', 'NH4'), ('env_phosphate', 'PO4'), ('env_substrate', 'Substrate'), ('env_labdatetime', 'Lab Date'), ('env_dnotes', 'Notes')], max_length=50, verbose_name='Environmental Measurements')),
                ('env_flow_rate', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True, verbose_name='Flow Rate (m/s)')),
                ('env_water_temp', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True, verbose_name='Water Temperature (C)')),
                ('env_salinity', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True, verbose_name='Salinity (PSU)')),
                ('env_ph_scale', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True, verbose_name='pH Scale')),
