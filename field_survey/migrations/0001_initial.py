    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('env_material', models.CharField(blank=True, choices=[(None, '(Unknown)'), ('water', 'Water [ENVO:00002006]'), ('soil', 'Soil [ENVO:00001998]'), ('sediment', 'Sediment [ENVO:00002007]'), ('other', 'Other')], max_length=50, verbose_name='Material')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('water_control_type', models.CharField(blank=True, choices=[(None, '(Unknown)'), ('field', 'Field'), ('lab', 'Lab'), ('extraction', 'Extraction'), ('no_template_control', 'No Template Control'), ('mock_community', 'Mock Community'), ('env_standard', 'Environmental Standard')], max_length=50, verbose_name='Control Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('field_sample_barcode', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='field_sample_barcode', to='sample_label.samplebarcode')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filter_protocol', models.ForeignKey(blank=True, null=True, to='utility.standardoperatingprocedure', on_delete=django.db.models.deletion.RESTRICT, verbose_name='Filter Protocol')),
                ('filter_protocol_other', models.CharField(blank=True, max_length=255, verbose_name='Other Filter Protocol')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subcore_protocol', models.ForeignKey(blank=True, null=True, to='utility.standardoperatingprocedure', on_delete=django.db.models.deletion.RESTRICT, verbose_name='Sub-Core Protocol')),
                ('subcore_protocol_other', models.CharField(blank=True, max_length=255, verbose_name='Other Sub-Core Protocol')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recorder_lname', models.CharField(blank=True, max_length=255, verbose_name='Recorder Last Name')),
                ('arrival_datetime', models.DateTimeField(blank=True, null=True, verbose_name='Arrival DateTime')),
                ('site_id', models.CharField(blank=True, max_length=8, verbose_name='Site ID')),
                ('site_id_other', models.CharField(blank=True, max_length=255, verbose_name='Site ID - Other')),
                ('site_name', models.CharField(blank=True, max_length=255, verbose_name='General Location Name')),
                ('lat_manual', models.DecimalField(decimal_places=16, max_digits=22, verbose_name='Latitude (DD)')),
                ('long_manual', models.DecimalField(decimal_places=16, max_digits=22, verbose_name='Latitude (DD)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subcore_protocol', models.CharField(blank=True, max_length=255, verbose_name='Sub-Core Protocol')),
                ('subcore_protocol_other', models.CharField(blank=True, max_length=255, verbose_name='Other Sub-Core Protocol')),
                ('subcore_method_other', models.CharField(blank=True, max_length=255, verbose_name='Other Sub-Core Method')),
                ('subcore_datetime_start', models.DateTimeField(blank=True, null=True, verbose_name='Sub-Core DateTime Start')),
                ('subcore_datetime_end', models.DateTimeField(blank=True, null=True, verbose_name='Sub-Core DateTime End')),
                ('subcore_min_barcode', models.CharField(blank=True, max_length=17, verbose_name='Min Sub-Core Barcode')),
                ('subcore_max_barcode', models.CharField(blank=True, max_length=17, verbose_name='Max Sub-Core Barcode')),
                ('subcore_number', models.IntegerField(blank=True, null=True, verbose_name='Number of Sub-Cores')),
                ('subcore_length', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True, verbose_name='Sub-Core Length (cm)')),
                ('subcore_diameter', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True, verbose_name='Sub-Core Diameter (cm)')),
                ('subcore_clayer', models.IntegerField(blank=True, null=True, verbose_name='Sub-Core Consistency Layer')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filter_lname', models.CharField(blank=True, max_length=255, verbose_name='Filterer Last Name')),
                ('filter_sample_label', models.CharField(blank=True, max_length=255, verbose_name='Filter Sample Label')),
                ('filter_barcode', models.CharField(blank=True, max_length=17, verbose_name='Filter Sample Barcode')),
                ('filter_datetime', models.DateTimeField(blank=True, null=True, verbose_name='Filter DateTime')),
                ('filter_protocol', models.CharField(blank=True, max_length=255, verbose_name='Filter Protocol')),
                ('filter_protocol_other', models.CharField(blank=True, max_length=255, verbose_name='Other Filter Protocol')),
