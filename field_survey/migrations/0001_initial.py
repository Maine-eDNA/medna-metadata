    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('env_obs_turbidity', models.CharField(blank=True,
                                                       choices=[(None, '(Unknown)'), ('none', 'None'), ('low', 'Low'),
                                                                ('medium', 'Medium'), ('high', 'High')], max_length=50,
                                                       verbose_name='Water Turbidity')),
                ('env_obs_precip', models.CharField(blank=True, choices=[(None, '(Unknown)'), ('none', 'None'),
                                                                         ('drizzle', 'Drizzle'),
                                                                         ('light_rain', 'Light rain'),
                                                                         ('mod_rain', 'Moderate rain'),
                                                                         ('heavy_rain', 'Heavy rain'), ('hail', 'Hail'),
                                                                         ('sleet', 'Sleet'),
                                                                         ('light_snow', 'Light snow'),
                                                                         ('mod_snow', 'Moderate snow'),
                                                                         ('heavy_snow', 'Heavy snow')], max_length=50,
                                                    verbose_name='Precipitation')),
                ('env_obs_wind_speed', models.CharField(blank=True, choices=[(None, '(Unknown)'), ('none', 'None'),
                                                                             ('light_wind', 'Light breeze'),
                                                                             ('mod_wind', 'Moderate breeze'),
                                                                             ('strong_wind', 'Strong wind')],
                                                        max_length=50, verbose_name='Wind Speed')),
                ('env_obs_cloud_cover', models.CharField(blank=True, choices=[(None, '(Unknown)'), ('none', 'None'),
                                                                              ('partly_cloudy', 'Partly cloudy'),
                                                                              ('full_cloudy', 'Full cloudy')],
                                                         max_length=50, verbose_name='Cloud Cover')),
                ...
                ('env_material', models.CharField(blank=True,
                                                  choices=[(None, '(Unknown)'), ('water', 'Water'), ('soil', 'Soil'),
                ...
                ('env_measure_mode', models.CharField(blank=True, choices=[(None, '(Unknown)'), ('on_foot', 'On Foot'),
                                                                           ('on_boat', 'Boat')], max_length=50,
                                                      verbose_name='Collection Mode')),
                ('env_boat_type', models.CharField(blank=True, max_length=255, verbose_name='Boat Type')),
                ('env_bottom_depth', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True,
                                                         verbose_name='Bottom Depth (m)')),
                ('measurements_taken', models.CharField(blank=True, choices=[(None, '(Unknown)'), ('no', 'No'), ('yes', 'Yes')],
                                  max_length=50, verbose_name='Measurements Taken')),
                ('survey_complete', models.CharField(blank=True, choices=[(None, '(Unknown)'), ('no', 'No'), ('yes', 'Yes')],
                                  max_length=50, verbose_name='Survey Complete')),
                ...
                ('gps_cap_lat', models.DecimalField(blank=True, decimal_places=16, max_digits=22, null=True,
                                                    verbose_name='Captured Latitude (DD)')),
                ('gps_cap_long', models.DecimalField(blank=True, decimal_places=16, max_digits=22, null=True,
                                                     verbose_name='Captured Longitude (DD)')),
                ('gps_cap_alt', models.DecimalField(blank=True, decimal_places=16, max_digits=22, null=True,
                                                    verbose_name='Captured Altitude (m)')),
                ('gps_cap_horacc', models.DecimalField(blank=True, decimal_places=16, max_digits=22, null=True,
                                                       verbose_name='Captured Horizontal Accuracy (m)')),
                ('gps_cap_vertacc', models.DecimalField(blank=True, decimal_places=16, max_digits=22, null=True,
                                                        verbose_name='Captured Vertical Accuracy (m)')),
                ...
                ('geom', django.contrib.gis.db.models.fields.PointField(srid=4326,
                                                                        verbose_name='Latitude, Longitude (DD WGS84)')),
                ('core_subcorer', models.ForeignKey(blank=True, null=True, on_delete=models.SET(utility.models.get_sentinel_user),
                                   related_name='core_subcorer', to=settings.AUTH_USER_MODEL,
                ...
                ('project_ids', models.ManyToManyField(related_name='project_ids', to='utility.Project',
                                                       verbose_name='Affiliated Project(s)')),
                ('qa_editor', models.ForeignKey(blank=True, null=True, on_delete=models.SET(utility.models.get_sentinel_user),
                                   related_name='qa_editor', to=settings.AUTH_USER_MODEL,
                                   verbose_name='Quality Editor')),
                ('record_creator', models.ForeignKey(blank=True, null=True, on_delete=models.SET(utility.models.get_sentinel_user),
                                   related_name='survey_record_creator', to=settings.AUTH_USER_MODEL,
                                   verbose_name='Survey Creator')),
                ('record_editor', models.ForeignKey(blank=True, null=True, on_delete=models.SET(utility.models.get_sentinel_user),
                                   related_name='survey_record_editor', to=settings.AUTH_USER_MODEL,
                                   verbose_name='Survey Editor')),
                ('site_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT,
                                              to='field_sites.fieldsite')),
                ('supervisor', models.ForeignKey(blank=True, null=True, on_delete=models.SET(utility.models.get_sentinel_user),
                                   related_name='supervisor', to=settings.AUTH_USER_MODEL, verbose_name='Supervisor')),
                ('username', models.ForeignKey(blank=True, null=True, on_delete=models.SET(utility.models.get_sentinel_user),
                                   related_name='username', to=settings.AUTH_USER_MODEL, verbose_name='Username')),
                ('water_filterer', models.ForeignKey(blank=True, null=True, on_delete=models.SET(utility.models.get_sentinel_user),
                                   related_name='water_filterer', to=settings.AUTH_USER_MODEL,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(default=utility.models.get_default_user,
                                                 ...
                                                 to=settings.AUTH_USER_MODEL)),
                ('record_creator', models.ForeignKey(blank=True, null=True, on_delete=models.SET(utility.models.get_sentinel_user),
                                   related_name='crew_record_creator', to=settings.AUTH_USER_MODEL,
                                   verbose_name='Crew Creator')),
                ('record_editor', models.ForeignKey(blank=True, null=True, on_delete=models.SET(utility.models.get_sentinel_user),
                                   related_name='crew_record_editor', to=settings.AUTH_USER_MODEL,
                ...
                ('survey_global_id', models.ForeignKey(db_column='survey_global_id', on_delete=django.db.models.deletion.CASCADE,
                                   related_name='fieldsurvey_to_fieldcrew', to='field_survey.fieldsurvey')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('survey_global_id', models.ForeignKey(db_column='survey_global_id', on_delete=django.db.models.deletion.CASCADE,
                                   related_name='fieldsurvey_to_fieldcollection', to='field_survey.fieldsurvey')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('field_collection', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False,
                                      to='field_survey.fieldcollection')),
                ('water_control', models.CharField(blank=True, choices=[(None, '(Unknown)'), ('no', 'No'), ('yes', 'Yes')],
                                  max_length=50, verbose_name='Is Control')),
                ('water_control_type', models.CharField(blank=True, choices=[(None, '(Unknown)'), ('field', 'Field'), ('lab', 'Lab')],
                                  max_length=50, verbose_name='Water Control Type')),
                ...
                ('water_collect_depth', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True,
                                                            verbose_name='Water Collection Depth')),
                ('water_collect_mode', models.CharField(blank=True, choices=[(None, '(Unknown)'), ('hand', 'By Hand'), (
                'niskin_handtoss', 'By Hand-Tossed Niskin'), ('niskin_array', 'By Array Niskin')], max_length=50,
                                                        verbose_name='Collection Mode')),
                ('water_niskin_number', models.IntegerField(blank=True, null=True, verbose_name='Niskin Number')),
                ('water_niskin_vol', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True,
                                                         verbose_name='Niskin Sample Volume')),
                ('water_vessel_vol', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True,
                                                         verbose_name='Water Vessel Volume')),
                ...
                ('was_filtered', models.CharField(blank=True, choices=[(None, '(Unknown)'), ('no', 'No'), ('yes', 'Yes')],
                                  max_length=50, verbose_name='Filtered')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('field_collection', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False,
                                      to='field_survey.fieldcollection')),
                ('core_control', models.CharField(blank=True, choices=[(None, '(Unknown)'), ('no', 'No'), ('yes', 'Yes')],
                                  max_length=50, verbose_name='Is Control')),
                ...
                ('core_method', models.CharField(blank=True, choices=[(None, '(Unknown)'), ('gravity', 'Gravity'),
                                                                      ('piston', 'Piston'), ('wedge', 'Wedge'),
                                                                      ('other', 'Other')], max_length=50,
                                                 verbose_name='Corer Method')),
                ('core_method_other', models.CharField(blank=True, max_length=255, verbose_name='Other Corer Method')),
                ('core_collect_depth', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True,
                                                           verbose_name='Core Depth (m)')),
                ('core_length', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True,
                                                    verbose_name='Core Length (cm)')),
                ('core_diameter', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True,
                                                      verbose_name='Core Diameter (cm)')),
                ...
                ('subcores_taken', models.CharField(blank=True, choices=[(None, '(Unknown)'), ('no', 'No'), ('yes', 'Yes')],
                                  max_length=50, verbose_name='Sub-Cored')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(default=utility.models.get_default_user, on_delete=models.SET(utility.models.get_sentinel_user), to=settings.AUTH_USER_MODEL)),
                ('field_sample_barcode', models.OneToOneField(limit_choices_to={'in_freezer': 'no'}, on_delete=django.db.models.deletion.RESTRICT, to='sample_labels.samplelabel')),
        ...
        migrations.CreateModel(
            name='FilterSample',
            fields=[
                ('field_sample', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='field_survey.fieldsample')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(default=utility.models.get_default_user,
                                                 ...
                                                 to=settings.AUTH_USER_MODEL)),
                ('survey_global_id', models.ForeignKey(db_column='survey_global_id', on_delete=django.db.models.deletion.CASCADE,
                                   related_name='fieldsurvey_to_fieldcrew_etl', to='field_survey.fieldsurveyetl')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('env_global_id', models.CharField(max_length=255, primary_key=True, serialize=False, verbose_name='Global ID')),
                ('env_measure_datetime', models.DateTimeField(blank=True, null=True, verbose_name='Measurement DateTime')),
                ('env_measure_depth', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True,
                                                          verbose_name='Measurement Depth (m)')),
                ...
                ('env_ysi_sn', models.CharField(blank=True, max_length=255, verbose_name='YSI Serial Number')),
                ('env_ysi_notes', models.TextField(blank=True, verbose_name='YSI Notes')),
                ('env_secchi_depth', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True,
                ...
                ('env_flow_rate', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True,
                                                      verbose_name='Flow Rate (m/s)')),
                ('env_water_temp', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True,
                                                       verbose_name='Water Temperature (C)')),
                ('env_salinity', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True,
                                                     verbose_name='Salinity (PSU)')),
                ('env_ph_scale', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True, verbose_name='pH Scale')),
                ('env_par1', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True,
                                                 verbose_name='PAR1 (Channel 1: Up μmoles/sec/m²)')),
                ('env_par2', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True,
                                                 verbose_name='PAR2 (Channel 2: Down μmoles/sec/m²)')),
                ('env_turbidity', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True,
                                                      verbose_name='Turbidity FNU (Formazin Nephelometric Unit)')),
                ('env_conductivity', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True,
                                                         verbose_name='Conductivity (μS/cm)')),
                ('env_do', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True,
                                               verbose_name='Dissolved Oxygen (mg/L)')),
                ('env_pheophytin', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True,
                                                       verbose_name='Pheophytin (µg/L)')),
                ('env_chla', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True,
                                                 verbose_name='Chlorophyll a (µg/L)')),
                ('env_no3no2', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True,
                                                   verbose_name='Nitrate and Nitrite (µM)')),
                ('env_no2', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True,
                                                verbose_name='Nitrite (µM)')),
                ('env_nh4', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True,
                                                verbose_name='Ammonium (µM)')),
                ('env_phosphate', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True,
                                                      verbose_name='Phosphate (µM)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subcore_number', models.IntegerField(blank=True, null=True, verbose_name='Number of Sub-Cores')),
                ('subcore_length', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True,
                                                       verbose_name='Sub-Core Length (cm)')),
                ('subcore_diameter', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True,
                                                         verbose_name='Sub-Core Diameter (cm)')),
                ('subcore_clayer', models.IntegerField(blank=True, null=True, verbose_name='Sub-Core Consistency Layer')),
                ('core_purpose', models.TextField(blank=True, verbose_name='Purpose of Other Cores')),
                ('core_notes', models.TextField(blank=True, verbose_name='Core Notes')),
                ('record_create_datetime', models.DateTimeField(blank=True, null=True, verbose_name='Survey Creation DateTime')),
                ...
                ('survey_global_id', models.ForeignKey(db_column='survey_global_id', on_delete=django.db.models.deletion.CASCADE,
                                   ...
                                   to='field_survey.fieldsurveyetl')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filter_method_other', models.CharField(blank=True, max_length=255, verbose_name='Other Filter Method')),
                ('filter_vol', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True,
                                                   verbose_name='Water Volume Filtered')),
                ('filter_type', models.CharField(blank=True, max_length=255, verbose_name='Filter Type')),
                ('filter_type_other', models.CharField(blank=True, max_length=255, verbose_name='Other Filter Type')),
                ('filter_pore', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True,
                                                    verbose_name='Filter Pore Size')),
                ('filter_size', models.DecimalField(blank=True, decimal_places=10, max_digits=15, null=True,
                ...
                ('record_edit_datetime', models.DateTimeField(blank=True, null=True, verbose_name='Survey Edit DateTime')),
                ('record_editor', models.CharField(blank=True, max_length=255, verbose_name='Survey Editor')),
                ('collection_global_id', models.ForeignKey(db_column='collection_global_id', on_delete=django.db.models.deletion.CASCADE,
                                   related_name='fieldcollection_to_samplefilter_etl',
                                   to='field_survey.fieldcollectionetl')),
                ('created_by', models.ForeignKey(default=utility.models.get_default_user,
                                                 on_delete=models.SET(utility.models.get_sentinel_user),
                                                 to=settings.AUTH_USER_MODEL)),
            ],
