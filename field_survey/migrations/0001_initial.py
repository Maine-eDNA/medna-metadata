    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('env_material', models.CharField(blank=True, choices=[(None, '(Unknown)'),
                                                                       ('water', 'Water'),
                                                                       ('soil', 'Soil'),
                                                                       ('other', 'Other')],
                                                  max_length=50, verbose_name='Material')),
                ...
                ('env_measure_mode', models.CharField(blank=True, choices=[(None, '(Unknown)'),
                                                                           ('on_foot', 'On Foot'),
                                                                           ('on_boat', 'Boat')],
                                                      max_length=50, verbose_name='Collection Mode')),
                ...
                ('measurements_taken', models.CharField(blank=True, choices=[(None, '(Unknown)'),
                                                                             ('no', 'No'),
                                                                             ('yes', 'Yes')],
                                                        max_length=50, verbose_name='Measurements Taken')),
                ('survey_complete', models.CharField(blank=True, choices=[(None, '(Unknown)'),
                                                                          ('no', 'No'),
                                                                          ('yes', 'Yes')],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('field_collection', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='field_survey.fieldcollection')),
                ('water_control', models.CharField(blank=True, choices=[(None, '(Unknown)'),
                                                                        ('no', 'No'),
                                                                        ('yes', 'Yes')],
                                                   max_length=50, verbose_name='Is Control')),
                ('water_control_type', models.CharField(blank=True, choices=[(None, '(Unknown)'),
                                                                             ('field', 'Field'),
                                                                             ('lab', 'Lab')],
                ...
                ('water_collect_mode', models.CharField(blank=True, choices=[(None, '(Unknown)'),
                                                                             ('hand', 'By Hand'),
                                                                             ('niskin_handtoss', 'By Hand-Tossed Niskin'),
                                                                             ('niskin_array', 'By Array Niskin')],
                                                        max_length=50, verbose_name='Collection Mode')),
                ...
                ('was_filtered', models.CharField(blank=True, choices=[(None, '(Unknown)'),
                                                                       ('no', 'No'),
                                                                       ('yes', 'Yes')],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('core_control', models.CharField(blank=True, choices=[(None, '(Unknown)'),
                                                                       ('no', 'No'),
                                                                       ('yes', 'Yes')],
                                                  max_length=50, verbose_name='Is Control')),
                ...
                ('core_method', models.CharField(blank=True, choices=[(None, '(Unknown)'),
                                                                      ('gravity', 'Gravity'),
                                                                      ('piston', 'Piston'),
                                                                      ('wedge', 'Wedge'),
                ...
                ('subcores_taken', models.CharField(blank=True, choices=[(None, '(Unknown)'),
                                                                         ('no', 'No'),
                                                                         ('yes', 'Yes')],
