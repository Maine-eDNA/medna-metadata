...
class FieldSurveyTable(tables.Table):
    ...
    lat_manual = tables.TemplateColumn('{{ record.lat_manual|floatformat:4|intcomma }}')
    long_manual = tables.TemplateColumn('{{ record.long_manual|floatformat:4|intcomma }}')
    ...
    gps_cap_lat = tables.TemplateColumn('{{ record.gps_cap_lat|floatformat:4|intcomma }}')
    gps_cap_long = tables.TemplateColumn('{{ record.gps_cap_long|floatformat:4|intcomma }}')
    gps_cap_alt = tables.TemplateColumn('{{ record.gps_cap_alt|floatformat:4|intcomma }}')
    gps_cap_horacc = tables.TemplateColumn('{{ record.gps_cap_horacc|floatformat:4|intcomma }}')
    gps_cap_vertacc = tables.TemplateColumn('{{ record.gps_cap_vertacc|floatformat:4|intcomma }}')
