...
class GeoFieldSurveyETLSerializer(GeoFeatureModelSerializer):
    ...
    site_id = serializers.CharField(max_length=8, allow_blank=True)
...
class EnvMeasurementETLSerializer(serializers.ModelSerializer):
    ...
    env_instrument = serializers.CharField(allow_blank=True)
    # env_ctd_fname
...
class FieldCollectionETLSerializer(serializers.ModelSerializer):
    ...
    subcore_min_barcode = serializers.CharField(max_length=17, allow_blank=True)
    subcore_max_barcode = serializers.CharField(max_length=17, allow_blank=True)
    ...
    core_purpose = serializers.CharField(allow_blank=True)
