...
class WaterCollectionTableSerializer(serializers.ModelSerializer):
    ...
    record_creator = serializers.ReadOnlyField(source='field_collection.record_creator.agol_username')
    record_create_datetime = serializers.ReadOnlyField(source='field_collection.record_create_datetime')
    record_editor = serializers.ReadOnlyField(source='field_collection.record_editor.agol_username')
    record_edit_datetime = serializers.ReadOnlyField(source='field_collection.record_edit_datetime')
...
class FilterSampleTableSerializer(serializers.ModelSerializer):
    ...
    record_creator = serializers.ReadOnlyField(source='field_sample.record_creator.agol_username')
    record_create_datetime = serializers.ReadOnlyField(source='field_sample.record_create_datetime')
    record_editor = serializers.ReadOnlyField(source='field_sample.record_editor.agol_username')
    record_edit_datetime = serializers.ReadOnlyField(source='field_sample.record_edit_datetime')
...
class SedimentCollectionSerializer(serializers.ModelSerializer):
    ...
    core_label = serializers.CharField(read_only=True, max_length=255, allow_blank=True)
    core_datetime_start = serializers.DateTimeField(read_only=True, allow_null=True)
    core_datetime_end = serializers.DateTimeField(read_only=True, allow_null=True)
    core_method = serializers.ChoiceField(read_only=True, choices=SedimentMethods.choices, allow_blank=True)
    core_method_other = serializers.CharField(read_only=True, max_length=255, allow_blank=True)
    core_collect_depth = serializers.DecimalField(read_only=True, max_digits=15, decimal_places=10, allow_null=True)
    core_length = serializers.DecimalField(read_only=True, max_digits=15, decimal_places=10, allow_null=True)
...
class FieldSampleSerializer(serializers.ModelSerializer):
    ...
    field_sample_barcode = serializers.PrimaryKeyRelatedField(many=False, read_only=True, allow_null=True)
...
class FieldSurveyEnvsNestedSerializer(GeoFeatureModelSerializer, EagerLoadingMixin):
    ...
    prefetch_related_fields = ('created_by', 'project_ids', 'site_id', 'username', 'supervisor', 'qa_editor',
                               'water_filterer', 'record_creator', 'record_editor')
...
class SubCoreSampleNestedSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = SubCoreSample
        fields = ['subcore_fname', 'subcore_lname', 'subcore_method', 'subcore_method_other',
                  'subcore_datetime_start', 'subcore_datetime_end', 'subcore_number', 'subcore_length',
                  'subcore_diameter', 'subcore_clayer', ]
...
class SedimentCollectionNestedSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['core_control', 'core_label', 'core_datetime_start', 'core_datetime_end', 'core_method',
                  'core_method_other', 'core_collect_depth', 'core_length', 'core_diameter', 'core_purpose',
...
class FieldSurveySubCoresNestedSerializer(GeoFeatureModelSerializer, EagerLoadingMixin):
    ...
    prefetch_related_fields = ('created_by', 'project_ids', 'site_id', 'username', 'supervisor', 'qa_editor',
                               'core_subcorer', 'record_creator', 'record_editor')
...
class GeoFieldSurveyETLSerializer(GeoFeatureModelSerializer):
    ...
    project_ids = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    supervisor = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    recorder_fname = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    recorder_lname = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    arrival_datetime = serializers.DateTimeField(allow_null=True)
    site_id = serializers.CharField(max_length=8, allow_blank=True, trim_whitespace=True)
    site_id_other = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    site_name = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    ...
    env_obs_turbidity = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    env_obs_precip = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    env_obs_wind_speed = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    env_obs_cloud_cover = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    env_biome = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    env_biome_other = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    env_feature = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    env_feature_other = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    env_material = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    env_material_other = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    env_notes = serializers.CharField(allow_blank=True, trim_whitespace=True)
    env_measure_mode = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    env_boat_type = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    env_bottom_depth = serializers.DecimalField(max_digits=15, decimal_places=10, allow_null=True)
    measurements_taken = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    core_subcorer = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    water_filterer = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    survey_complete = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    qa_editor = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    qa_datetime = serializers.DateTimeField(allow_null=True)
    qa_initial = serializers.CharField(max_length=200, allow_blank=True, trim_whitespace=True)
    ...
    record_creator = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    record_edit_datetime = serializers.DateTimeField(allow_null=True)
    record_editor = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    created_datetime = serializers.DateTimeField(read_only=True)
    modified_datetime = serializers.DateTimeField(read_only=True)
...
class FieldCrewETLSerializer(serializers.ModelSerializer):
    ...
    crew_fname = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    crew_lname = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    record_create_datetime = serializers.DateTimeField(allow_null=True)
    record_creator = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    record_edit_datetime = serializers.DateTimeField(allow_null=True)
    record_editor = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
...
class EnvMeasurementETLSerializer(serializers.ModelSerializer):
    ...
    env_instrument = serializers.CharField(allow_blank=True, trim_whitespace=True)
    # env_ctd_fname
    env_ctd_filename = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    env_ctd_notes = serializers.CharField(allow_blank=True, trim_whitespace=True)
    # env_ysi_fname
    env_ysi_filename = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    env_ysi_model = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    env_ysi_sn = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    env_ysi_notes = serializers.CharField(allow_blank=True, trim_whitespace=True)
    env_secchi_depth = serializers.DecimalField(max_digits=15, decimal_places=10, allow_null=True)
    env_secchi_notes = serializers.CharField(allow_blank=True, trim_whitespace=True)
    env_niskin_number = serializers.IntegerField(allow_null=True)
    env_niskin_notes = serializers.CharField(allow_blank=True, trim_whitespace=True)
    env_inst_other = serializers.CharField(allow_blank=True, trim_whitespace=True)
    env_measurement = serializers.CharField(allow_blank=True, trim_whitespace=True)
    ...
    env_substrate = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    env_lab_datetime = serializers.DateTimeField(allow_null=True)
    env_measure_notes = serializers.CharField(allow_blank=True, trim_whitespace=True)
    record_create_datetime = serializers.DateTimeField(allow_null=True)
    record_creator = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    record_edit_datetime = serializers.DateTimeField(allow_null=True)
    record_editor = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
...
class FieldCollectionETLSerializer(serializers.ModelSerializer):
    ...
    collection_type = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    water_control = serializers.CharField(max_length=3, allow_blank=True, trim_whitespace=True)
    water_control_type = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    water_vessel_label = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    ...
    water_collect_mode = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    ...
    water_vessel_material = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    water_vessel_color = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    water_collect_notes = serializers.CharField(allow_blank=True, trim_whitespace=True)
    was_filtered = serializers.CharField(max_length=3, allow_blank=True, trim_whitespace=True)
    core_control = serializers.CharField(max_length=3, allow_blank=True, trim_whitespace=True)
    core_label = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    core_datetime_start = serializers.DateTimeField(allow_null=True)
    core_datetime_end = serializers.DateTimeField(allow_null=True)
    core_method = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    core_method_other = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    ...
    # subcorestaken
    subcores_taken = serializers.CharField(max_length=3, allow_blank=True, trim_whitespace=True)
    subcore_fname = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    subcore_lname = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    subcore_protocol = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    subcore_protocol_other = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    subcore_method = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    subcore_method_other = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    ...
    subcore_min_barcode = serializers.CharField(max_length=17, allow_blank=True, trim_whitespace=True)
    subcore_max_barcode = serializers.CharField(max_length=17, allow_blank=True, trim_whitespace=True)
    ...
    core_purpose = serializers.CharField(allow_blank=True, trim_whitespace=True)
    core_notes = serializers.CharField(allow_blank=True, trim_whitespace=True)
    record_create_datetime = serializers.DateTimeField(allow_null=True)
    record_creator = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    record_edit_datetime = serializers.DateTimeField(allow_null=True)
    record_editor = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
...
class SampleFilterETLSerializer(serializers.ModelSerializer):
    ...
    filter_location = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    is_prefilter = serializers.CharField(max_length=3, allow_blank=True, trim_whitespace=True)
    filter_fname = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    filter_lname = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    filter_sample_label = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    filter_barcode = serializers.CharField(max_length=17, allow_blank=True, trim_whitespace=True)
    filter_datetime = serializers.DateTimeField(allow_null=True)
    filter_protocol = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    filter_protocol_other = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    filter_method = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    filter_method_other = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    filter_vol = serializers.DecimalField(max_digits=15, decimal_places=10, allow_null=True)
    filter_type = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    filter_type_other = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    ...
    filter_notes = serializers.CharField(allow_blank=True, trim_whitespace=True)
    record_create_datetime = serializers.DateTimeField(allow_null=True)
    record_creator = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
    record_edit_datetime = serializers.DateTimeField(allow_null=True)
    record_editor = serializers.CharField(max_length=255, allow_blank=True, trim_whitespace=True)
