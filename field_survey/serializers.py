...
class FieldSurveySerializer(serializers.ModelSerializer):
    ...
    env_bottom_depth = serializers.DecimalField()
    ...
    gps_cap_alt = serializers.DecimalField()
    gps_cap_horiz_acc = serializers.DecimalField()
    gps_cap_vert_acc = serializers.DecimalField()
    record_create_datetime = serializers.DateTimeField()
    record_edit_datetime = serializers.DateTimeField()
...
class EnvMeasurementSerializer(serializers.ModelSerializer):
    ...
    env_measure_depth = serializers.DecimalField()
    ...
    env_secchi_depth = serializers.DecimalField()
    ...
    env_flow_rate = serializers.DecimalField()
    env_water_temp = serializers.DecimalField()
    # env_sal
    env_salinity = serializers.DecimalField()
    env_ph_scale = serializers.DecimalField()
    env_par1 = serializers.DecimalField()
    env_par2 = serializers.DecimalField()
    env_turbidity = serializers.DecimalField()
    env_conductivity = serializers.DecimalField()
    env_do = serializers.DecimalField()
    env_pheophytin = serializers.DecimalField()
    env_chla = serializers.DecimalField()
    env_no3no2 = serializers.DecimalField()
    env_no2 = serializers.DecimalField()
    env_nh4 = serializers.DecimalField()
    env_phosphate = serializers.DecimalField()
...
class FieldCollectionSerializer(serializers.ModelSerializer):
    ...
    water_collect_depth = serializers.DecimalField()
    water_collect_mode = serializers.CharField()
    water_niskin_number = serializers.IntegerField()
    water_niskin_vol = serializers.DecimalField()
    water_vessel_vol = serializers.DecimalField()
    ...
    core_collect_depth = serializers.DecimalField()
    core_length = serializers.DecimalField()
    core_diameter = serializers.DecimalField()
...
class FieldSampleSerializer(serializers.ModelSerializer):
    ...
    filter_vol = serializers.DecimalField()
    ...
    subcore_length = serializers.DecimalField()
    subcore_diameter = serializers.DecimalField()
