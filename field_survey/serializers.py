...
class FieldSurveySerializer(serializers.ModelSerializer):
    ...
    env_notes = serializers.CharField(max_length=255, allow_blank=True)
    ...
    env_bottom_depth = serializers.DecimalField(max_digits=10, decimal_places=10, allow_null=True)
...
class EnvMeasurementSerializer(serializers.ModelSerializer):
    ...
    env_measure_depth = serializers.DecimalField(max_digits=10, decimal_places=10, allow_null=True)
    ...
    env_ctd_notes = serializers.CharField(max_length=255, allow_blank=True)
    # env_ysi_fname
    ...
    env_ysi_notes = serializers.CharField(max_length=255, allow_blank=True)
    env_secchi_depth = serializers.DecimalField(max_digits=10, decimal_places=10, allow_null=True)
    env_secchi_notes = serializers.CharField(max_length=255, allow_blank=True)
    env_niskin_number = serializers.IntegerField(allow_null=True)
    env_niskin_notes = serializers.CharField(max_length=255, allow_blank=True)
    ...
    env_flow_rate = serializers.DecimalField(max_digits=10, decimal_places=10, allow_null=True)
    env_water_temp = serializers.DecimalField(max_digits=10, decimal_places=10, allow_null=True)
    # env_sal
    env_salinity = serializers.DecimalField(max_digits=10, decimal_places=10, allow_null=True)
    env_ph_scale = serializers.DecimalField(max_digits=10, decimal_places=10, allow_null=True)
    env_par1 = serializers.DecimalField(max_digits=10, decimal_places=10, allow_null=True)
    env_par2 = serializers.DecimalField(max_digits=10, decimal_places=10, allow_null=True)
    env_turbidity = serializers.DecimalField(max_digits=10, decimal_places=10, allow_null=True)
    env_conductivity = serializers.DecimalField(max_digits=10, decimal_places=10, allow_null=True)
    env_do = serializers.DecimalField(max_digits=10, decimal_places=10, allow_null=True)
    env_pheophytin = serializers.DecimalField(max_digits=10, decimal_places=10, allow_null=True)
    env_chla = serializers.DecimalField(max_digits=10, decimal_places=10, allow_null=True)
    env_no3no2 = serializers.DecimalField(max_digits=10, decimal_places=10, allow_null=True)
    env_no2 = serializers.DecimalField(max_digits=10, decimal_places=10, allow_null=True)
    env_nh4 = serializers.DecimalField(max_digits=10, decimal_places=10, allow_null=True)
    env_phosphate = serializers.DecimalField(max_digits=10, decimal_places=10, allow_null=True)
    ...
    env_measure_notes = serializers.CharField(max_length=255, allow_blank=True)
    created_datetime = serializers.DateTimeField()
...
class FieldCollectionSerializer(serializers.ModelSerializer):
    ...
    water_collect_depth = serializers.DecimalField(max_digits=10, decimal_places=10, allow_null=True)
    ...
    water_niskin_vol = serializers.DecimalField(max_digits=10, decimal_places=10, allow_null=True)
    water_vessel_vol = serializers.DecimalField(max_digits=10, decimal_places=10, allow_null=True)
    ...
    core_collect_depth = serializers.DecimalField(max_digits=10, decimal_places=10, allow_null=True)
    core_length = serializers.DecimalField(max_digits=10, decimal_places=10, allow_null=True)
    core_diameter = serializers.DecimalField(max_digits=10, decimal_places=10, allow_null=True)
...
class FieldSampleSerializer(serializers.ModelSerializer):
    ...
    filter_vol = serializers.DecimalField(max_digits=10, decimal_places=10, allow_null=True)
    ...
    filter_notes = serializers.CharField(max_length=255, allow_blank=True)
    ...
    subcore_length = serializers.DecimalField(max_digits=10, decimal_places=10, allow_null=True)
    subcore_diameter = serializers.DecimalField(max_digits=10, decimal_places=10, allow_null=True)
