                ...
                if (data.notice) {
                    ...
                    $.each(data.notice, function(key, value){ // The contents inside notice
                        ...
                        if (value.notice_type == "biocultural") {
                            $lcResponse.html("<div class='row'><div class='col-md-3 col-12 my-auto'><a target='_blank' href="+value.bc_svg_url+"><img class='w-100 border-radius-lg shadow-lg' src="+value.bc_svg_url+" alt="+value.notice_type+"></a></div><div class='col-md-9 col-12 my-auto'><p class='pe-md-5'>"+value.bc_default_text+"</p><table class='table align-items-center mb-0' style='text-transform:capitalize;'><tbody><tr><td class='align-middle text-center'><div class='d-flex align-items-center'><span class='me-2 text-xs'>"+"Notice Type"+"</span></div></td><td class='align-middle text-center'><div class='d-flex align-items-center'><span class='me-2 text-xs'>"+value.notice_type+"</span></div></td></tr><tr><td class='align-middle text-center'><div class='d-flex align-items-center'><span class='me-2 text-xs'>"+"Created"+"</span></div></td><td class='align-middle text-center'><div class='d-flex align-items-center'><span class='me-2 text-xs'>"+$createdDateFmt+"</span></div></td></tr><tr><td class='align-middle text-center'><div class='d-flex align-items-center'><span class='me-2 text-xs'>"+"Updated"+"</span></div></td><td class='align-middle text-center'><div class='d-flex align-items-center'><span class='me-2 text-xs'>"+$updatedDateFmt+"</span></div></td></tr></tbody></table></div></div>")
                          }
                        if (value.notice_type == "traditional_knowledge") {
                            $lcResponse.html("<div class='row'><div class='col-md-3 col-12 my-auto'><a target='_blank' href="+value.tk_svg_url+"><img class='w-100 border-radius-lg shadow-lg' src="+value.tk_svg_url+" alt="+value.notice_type+"></a></div><div class='col-md-9 col-12 my-auto'><p class='pe-md-5'>"+value.tk_default_text+"</p><table class='table align-items-center mb-0' style='text-transform:capitalize;'><tbody><tr><td class='align-middle text-center'><div class='d-flex align-items-center'><span class='me-2 text-xs'>"+"Notice Type"+"</span></div></td><td class='align-middle text-center'><div class='d-flex align-items-center'><span class='me-2 text-xs'>"+value.notice_type+"</span></div></td></tr><tr><td class='align-middle text-center'><div class='d-flex align-items-center'><span class='me-2 text-xs'>"+"Created"+"</span></div></td><td class='align-middle text-center'><div class='d-flex align-items-center'><span class='me-2 text-xs'>"+$createdDateFmt+"</span></div></td></tr><tr><td class='align-middle text-center'><div class='d-flex align-items-center'><span class='me-2 text-xs'>"+"Updated"+"</span></div></td><td class='align-middle text-center'><div class='d-flex align-items-center'><span class='me-2 text-xs'>"+$updatedDateFmt+"</span></div></td></tr></tbody></table></div></div>")
                          }
                    });
                }
