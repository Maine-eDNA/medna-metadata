...
urlpatterns = [
    ...
    path('dashboard/options/biome/fifth/', fieldsite_views.load_biome_fifth, name='options_biome_fifth'),
    path('dashboard/options/feature/second/', fieldsite_views.load_feature_second, name='options_feature_second'),
    path('dashboard/options/feature/third/', fieldsite_views.load_feature_third, name='options_feature_third'),
    path('dashboard/options/feature/fourth/', fieldsite_views.load_feature_fourth, name='options_feature_fourth'),
    path('dashboard/options/feature/fifth/', fieldsite_views.load_feature_fifth, name='options_feature_fifth'),
