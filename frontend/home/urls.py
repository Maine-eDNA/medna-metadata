...
urlpatterns = [
    ...
    path('dashboard/samplelabel/detail/', samplelabel_views.SampleLabelRequestDetailView.as_view(), name='detail_samplelabelrequest'),
    ...
    path('main/project_detail/<int:pk>/', utility_views.ProjectSurveyTemplateView.as_view(), name='detail_project'),
