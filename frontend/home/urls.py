...
urlpatterns = [
    ...
    # AJAX OPTIONS
    path('dashboard/biome/second/', fieldsite_views.load_biome_second, name='options_biome_second'),
    path('dashboard/biome/third/', fieldsite_views.load_biome_third, name='options_biome_third'),
    path('dashboard/biome/fourth/', fieldsite_views.load_biome_fourth, name='options_biome_fourth'),
    path('dashboard/biome/fifth/', fieldsite_views.load_biome_fifth, name='options_biome_fifth'),
    path('dashboard/feature/second/', fieldsite_views.load_feature_second, name='options_feature_second'),
    path('dashboard/feature/third/', fieldsite_views.load_feature_third, name='options_feature_third'),
    path('dashboard/feature/fourth/', fieldsite_views.load_feature_fourth, name='options_feature_fourth'),
    path('dashboard/feature/fifth/', fieldsite_views.load_feature_fifth, name='options_feature_fifth'),
    path('dashboard/feature/sixth/', fieldsite_views.load_feature_sixth, name='options_feature_sixth'),
    path('dashboard/feature/seventh/', fieldsite_views.load_feature_seventh, name='options_feature_seventh'),
