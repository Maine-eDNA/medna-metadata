...
urlpatterns = [
    ...
    path('dashboard/samplelabel/view/', SampleLabelRequestFilterView.as_view(filterset_class=SampleLabelRequestFilter, template='home/django-material-dashboard/field-list.html'), name='view_samplelabelrequest'),
    ...
    path('dashboard/fieldsite/view/', SampleLabelRequestFilterView.as_view(filterset_class=SampleLabelRequestFilter, template='home/django-material-dashboard/field-list.html'), name='view_fieldsite'),
