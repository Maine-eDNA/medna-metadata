...
urlpatterns = [
    ...
    path('dashboard/samplelabel/add/<int:site_id>/<int:sample_material>/<str:purpose>/', samplelabel_views.AddSampleLabelRequestView.as_view(success_url=reverse_lazy('detail_samplelabelrequest')), name='add_samplelabelrequest'),
