...
class DenoiseClusterMetadataSerializer(serializers.ModelSerializer):
    ...
    analysis_sop = serializers.SlugRelatedField(many=False, read_only=False, allow_null=True, slug_field='sop_title', queryset=StandardOperatingProcedure.objects.all())
    process_location = serializers.SlugRelatedField(many=False, read_only=False, slug_field='process_location_name_slug', queryset=ProcessLocation.objects.all())
    quality_metadata = serializers.SlugRelatedField(many=False, read_only=False, slug_field='quality_slug', queryset=QualityMetadata.objects.all())
    denoise_cluster_method = serializers.SlugRelatedField(many=False, read_only=False, slug_field='denoise_cluster_method_slug', queryset=DenoiseClusterMethod.objects.all())
...
class MixsWaterSerializer(serializers.ModelSerializer):
    ...
    ta_taxon = serializers.ReadOnlyField()
    ta_domain = serializers.ReadOnlyField()
    ta_kingdom = serializers.ReadOnlyField()
    ta_supergroup = serializers.ReadOnlyField()
    ta_phylum_division = serializers.ReadOnlyField()
    ta_class = serializers.ReadOnlyField()
    ta_order = serializers.ReadOnlyField()
    ta_family = serializers.ReadOnlyField()
    ta_genus = serializers.ReadOnlyField()
    ta_species = serializers.ReadOnlyField()
    ta_common_name = serializers.ReadOnlyField()
    ...
    submitted_to_insdc = serializers.ReadOnlyField(source='feature.denoise_cluster_metadata.quality_metadata.run_result.run_results.submitted_to_insdc')
    investigation_type = serializers.ReadOnlyField(source='feature.denoise_cluster_metadata.quality_metadata.run_result.run_results.investigation_type')
    project_name = serializers.ReadOnlyField(source='feature.denoise_cluster_metadata.quality_metadata.run_result.run_prep.pooled_library.library_prep.extraction.field_sample.collection_global_id.survey_global_id.mixs_project_name')
    lat_lon = serializers.ReadOnlyField(source='feature.denoise_cluster_metadata.quality_metadata.run_result.run_prep.pooled_library.library_prep.extraction.field_sample.collection_global_id.survey_global_id.mixs_lat_lon')
    depth = serializers.ReadOnlyField(source='feature.denoise_cluster_metadata.quality_metadata.run_result.run_prep.pooled_library.library_prep.extraction.field_sample.filter_sample.mixs_depth')
    geo_loc_name = serializers.ReadOnlyField(source='feature.denoise_cluster_metadata.quality_metadata.run_result.run_prep.pooled_library.library_prep.extraction.field_sample.collection_global_id.survey_global_id.site_id.mixs_geo_loc_name')
    collection_date = serializers.ReadOnlyField(source='feature.denoise_cluster_metadata.quality_metadata.run_result.run_prep.pooled_library.library_prep.extraction.field_sample.collection_global_id.water_collection.collect_datetime')
    env_broad_scale = serializers.ReadOnlyField(source='feature.denoise_cluster_metadata.quality_metadata.run_result.run_prep.pooled_library.library_prep.extraction.field_sample.collection_global_id.survey_global_id.site_id.mixs_env_broad_scale')
    env_local_scale = serializers.ReadOnlyField(source='feature.denoise_cluster_metadata.quality_metadata.run_result.run_prep.pooled_library.library_prep.extraction.field_sample.collection_global_id.survey_global_id.site_id.mixs_env_local_scale')
    env_medium = serializers.ReadOnlyField(source='feature.denoise_cluster_metadata.quality_metadata.run_result.run_prep.pooled_library.library_prep.extraction.field_sample.collection_global_id.survey_global_id.mixs_env_medium')
    source_mat_id = serializers.ReadOnlyField(source='feature.denoise_cluster_metadata.quality_metadata.run_result.run_prep.pooled_library.library_prep.extraction.field_sample.sample_global_id')
    samp_collect_device = serializers.ReadOnlyField(source='feature.denoise_cluster_metadata.quality_metadata.run_result.run_prep.pooled_library.library_prep.extraction.field_sample.filter_sample.mixs_samp_collect_device')
    samp_mat_process = serializers.ReadOnlyField(source='feature.denoise_cluster_metadata.quality_metadata.run_result.run_prep.pooled_library.library_prep.extraction.field_sample.filter_sample.mixs_samp_mat_process')
    nucl_acid_ext = serializers.ReadOnlyField(source='feature.denoise_cluster_metadata.quality_metadata.run_result.run_prep.pooled_library.library_prep.extraction.mixs_nucl_acid_ext')
    nucl_acid_amp = serializers.ReadOnlyField(source='feature.denoise_cluster_metadata.quality_metadata.run_result.run_prep.pooled_library.library_prep.mixs_nucl_acid_amp')
    lib_layout = serializers.ReadOnlyField(source='feature.denoise_cluster_metadata.quality_metadata.run_result.run_prep.pooled_library.library_prep.lib_prep_layout')
    target_gene = serializers.ReadOnlyField(source='feature.denoise_cluster_metadata.quality_metadata.run_result.run_prep.pooled_library.library_prep.primer_set.primer_target_gene')
    target_subfragment = serializers.ReadOnlyField(source='feature.denoise_cluster_metadata.quality_metadata.run_result.run_prep.pooled_library.library_prep.primer_set.primer_subfragment')
    pcr_primers = serializers.ReadOnlyField(source='feature.denoise_cluster_metadata.quality_metadata.run_result.run_prep.pooled_library.library_prep.primer_set.mixs_pcr_primers')
    mid = serializers.ReadOnlyField(source='feature.denoise_cluster_metadata.quality_metadata.run_result.run_prep.pooled_library.library_prep.index_pair.mixs_mid')
    adapters = serializers.ReadOnlyField(source='feature.denoise_cluster_metadata.quality_metadata.run_result.run_prep.pooled_library.library_prep.index_pair.index_adapter')
    pcr_cond = serializers.ReadOnlyField(source='feature.denoise_cluster_metadata.quality_metadata.run_result.run_prep.pooled_library.library_prep.lib_prep_thermal_cond')
    seq_meth = serializers.ReadOnlyField(source='feature.denoise_cluster_metadata.quality_metadata.run_result.run_results.seq_meth')
    seq_quality_check = serializers.ReadOnlyField(source='feature.denoise_cluster_metadata.quality_metadata.seq_quality_check')
    chimera_check = serializers.ReadOnlyField(source='feature.denoise_cluster_metadata.quality_metadata.chimera_check')
...
class MixsSedimentSerializer(serializers.ModelSerializer):
    ...
    project_name = serializers.ReadOnlyField(source='feature.denoise_cluster_metadata.quality_metadata.run_result.run_prep.pooled_library.library_prep.extraction.field_sample.collection_global_id.survey_global_id.mixs_project_name')
    lat_lon = serializers.ReadOnlyField(source='feature.denoise_cluster_metadata.quality_metadata.run_result.run_prep.pooled_library.library_prep.extraction.field_sample.collection_global_id.survey_global_id.mixs_lat_lon')
    depth = serializers.ReadOnlyField(source='feature.denoise_cluster_metadata.quality_metadata.run_result.run_prep.pooled_library.library_prep.extraction.field_sample.subcore_sample.mixs_depth')
    geo_loc_name = serializers.ReadOnlyField(source='feature.denoise_cluster_metadata.quality_metadata.run_result.run_prep.pooled_library.library_prep.extraction.field_sample.collection_global_id.survey_global_id.site_id.mixs_geo_loc_name')
    collection_date = serializers.ReadOnlyField(source='feature.denoise_cluster_metadata.quality_metadata.run_result.run_prep.pooled_library.library_prep.extraction.field_sample.collection_global_id.sediment_collection.core_datetime_start')
    env_broad_scale = serializers.ReadOnlyField(source='feature.denoise_cluster_metadata.quality_metadata.run_result.run_prep.pooled_library.library_prep.extraction.field_sample.collection_global_id.survey_global_id.site_id.mixs_env_broad_scale')
    env_local_scale = serializers.ReadOnlyField(source='feature.denoise_cluster_metadata.quality_metadata.run_result.run_prep.pooled_library.library_prep.extraction.field_sample.collection_global_id.survey_global_id.site_id.mixs_env_local_scale')
    env_medium = serializers.ReadOnlyField(source='feature.denoise_cluster_metadata.quality_metadata.run_result.run_prep.pooled_library.library_prep.extraction.field_sample.collection_global_id.survey_global_id.mixs_env_medium')
    source_mat_id = serializers.ReadOnlyField(source='feature.denoise_cluster_metadata.quality_metadata.run_result.run_prep.pooled_library.library_prep.extraction.field_sample.sample_global_id')
    samp_collect_device = serializers.ReadOnlyField(source='feature.denoise_cluster_metadata.quality_metadata.run_result.run_prep.pooled_library.library_prep.extraction.field_sample.subcore_sample.mixs_samp_collect_device')
    samp_mat_process = serializers.ReadOnlyField(source='feature.denoise_cluster_metadata.quality_metadata.run_result.run_prep.pooled_library.library_prep.extraction.field_sample.subcore_sample.mixs_samp_mat_process')
    nucl_acid_ext = serializers.ReadOnlyField(source='feature.denoise_cluster_metadata.quality_metadata.run_result.run_prep.pooled_library.library_prep.extraction.mixs_nucl_acid_ext')
    nucl_acid_amp = serializers.ReadOnlyField(source='feature.denoise_cluster_metadata.quality_metadata.run_result.run_prep.pooled_library.library_prep.mixs_nucl_acid_amp')
    lib_layout = serializers.ReadOnlyField(source='feature.denoise_cluster_metadata.quality_metadata.run_result.run_prep.pooled_library.library_prep.lib_prep_layout')
    target_gene = serializers.ReadOnlyField(source='feature.denoise_cluster_metadata.quality_metadata.run_result.run_prep.pooled_library.library_prep.primer_set.primer_target_gene')
