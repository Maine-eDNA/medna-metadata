...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('taxon_supergroup', models.CharField(max_length=255, unique=True, verbose_name='Phylum/Division')),
                ('taxon_supergroup_slug', models.SlugField(max_length=255, verbose_name='Phylum Slug')),
            ...
            options={
                ...
                'verbose_name_plural': 'Taxon Supergroup',
            },
        ),
        migrations.CreateModel(
