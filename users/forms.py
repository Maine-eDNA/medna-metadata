...
class CustomUserUpdateForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            Row(
                Div(
                    Column(Field('last_name', css_class='form-control'), css_class='input-group input-group-dynamic label-floating mb-4'),
                    css_class='col-md-6'),
                Div(
                    Column(Field('first_name', css_class='form-control'), css_class='input-group input-group-dynamic label-floating'),
