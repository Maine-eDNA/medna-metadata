...
from utility.models import Fund
...
class FieldSiteSerializer(serializers.ModelSerializer):
    ...
    fund = serializers.SlugRelatedField(many=False, read_only=False, slug_field='fund_code', queryset=Fund.objects.all())
...
class EnvoBiomeFirstSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'biome_first_tier_slug', 'biome_first_tier', 'envo_identifier', 'ontology_url',
                  'created_by', 'created_datetime', 'modified_datetime', ]
    # Since fund, system, watershed, and created_by reference different tables and we
    # want to show 'label' rather than some unintelligible field (like pk 1), have to add
    # slug to tell it to print the desired field from the other table
...
class EnvoBiomeSecondSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'biome_second_tier_slug', 'biome_second_tier', 'biome_first_tier_slug', 'biome_first_tier',
                  'envo_identifier', 'ontology_url', 'created_by', 'created_datetime', 'modified_datetime', ]
    # Since fund, system, watershed, and created_by reference different tables and we
    # want to show 'label' rather than some unintelligible field (like pk 1), have to add
    # slug to tell it to print the desired field from the other table
    created_by = serializers.SlugRelatedField(many=False, read_only=True, slug_field='email')
    biome_first_tier = serializers.SlugRelatedField(many=False, read_only=False, slug_field='biome_first_tier_slug', queryset=EnvoBiomeFirst.objects.all())
...
class EnvoBiomeThirdSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'biome_third_tier_slug', 'biome_third_tier', 'biome_second_tier_slug', 'biome_second_tier',
    ...
    # slug to tell it to print the desired field from the other table
    created_by = serializers.SlugRelatedField(many=False, read_only=True, slug_field='email')
    biome_second_tier = serializers.SlugRelatedField(many=False, read_only=False, slug_field='biome_second_tier_slug', queryset=EnvoBiomeSecond.objects.all())
...
class EnvoBiomeFourthSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'biome_fourth_tier_slug', 'biome_fourth_tier', 'biome_third_tier_slug', 'biome_third_tier',
                  'biome_second_tier_slug', 'biome_first_tier_slug', 'envo_identifier', 'ontology_url',
                  'created_by', 'created_datetime', 'modified_datetime', ]
    # Since fund, system, watershed, and created_by reference different tables and we
    # want to show 'label' rather than some unintelligible field (like pk 1), have to add
    # slug to tell it to print the desired field from the other table
    created_by = serializers.SlugRelatedField(many=False, read_only=True, slug_field='email')
    biome_third_tier = serializers.SlugRelatedField(many=False, read_only=False, slug_field='biome_third_tier_slug', queryset=EnvoBiomeThird.objects.all())
...
class EnvoBiomeFifthSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'biome_fifth_tier_slug', 'biome_fifth_tier', 'biome_fourth_tier_slug', 'biome_fourth_tier',
                  'biome_third_tier_slug', 'biome_second_tier_slug', 'biome_first_tier_slug', 'envo_identifier', 'ontology_url',
                  'created_by', 'created_datetime', 'modified_datetime', ]
    # Since fund, system, watershed, and created_by reference different tables and we
    # want to show 'label' rather than some unintelligible field (like pk 1), have to add
    # slug to tell it to print the desired field from the other table
    created_by = serializers.SlugRelatedField(many=False, read_only=True, slug_field='email')
    biome_fourth_tier = serializers.SlugRelatedField(many=False, read_only=False, slug_field='biome_fourth_tier_slug', queryset=EnvoBiomeFourth.objects.all())
...
class EnvoFeatureSecondSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'feature_second_tier_slug', 'feature_second_tier', 'feature_first_tier_slug', 'feature_first_tier', 'envo_identifier', 'ontology_url',
                  'created_by', 'created_datetime', 'modified_datetime', ]
    ...
    # slug to tell it to print the desired field from the other table
    created_by = serializers.SlugRelatedField(many=False, read_only=True, slug_field='email')
    feature_first_tier = serializers.SlugRelatedField(many=False, read_only=False, slug_field='feature_first_tier_slug', queryset=EnvoFeatureFirst.objects.all())
...
class EnvoFeatureThirdSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'feature_third_tier_slug', 'feature_third_tier', 'feature_second_tier_slug', 'feature_second_tier',
...
class EnvoFeatureFourthSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'feature_fourth_tier_slug', 'feature_fourth_tier', 'feature_third_tier_slug', 'feature_third_tier',
                  'feature_second_tier_slug', 'feature_first_tier_slug', 'envo_identifier', 'ontology_url',
                  'created_by', 'created_datetime', 'modified_datetime', ]
    ...
    # slug to tell it to print the desired field from the other table
    created_by = serializers.SlugRelatedField(many=False, read_only=True, slug_field='email')
    feature_third_tier = serializers.SlugRelatedField(many=False, read_only=False, slug_field='feature_third_tier_slug', queryset=EnvoFeatureThird.objects.all())
...
class EnvoFeatureFifthSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'feature_fifth_tier_slug', 'feature_fifth_tier', 'feature_fourth_tier_slug', 'feature_fourth_tier',
                  'feature_third_tier_slug', 'feature_second_tier_slug', 'feature_first_tier_slug', 'envo_identifier', 'ontology_url',
                  'created_by', 'created_datetime', 'modified_datetime', ]
    ...
    # slug to tell it to print the desired field from the other table
    created_by = serializers.SlugRelatedField(many=False, read_only=True, slug_field='email')
    feature_fourth_tier = serializers.SlugRelatedField(many=False, read_only=False, slug_field='feature_fourth_tier_slug', queryset=EnvoFeatureFourth.objects.all())
...
class EnvoFeatureSixthSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'feature_sixth_tier_slug', 'feature_sixth_tier', 'feature_fifth_tier_slug', 'feature_fifth_tier',
                  'feature_fourth_tier_slug', 'feature_third_tier_slug', 'feature_second_tier_slug', 'feature_first_tier_slug', 'envo_identifier', 'ontology_url',
                  'created_by', 'created_datetime', 'modified_datetime', ]
    # Since fund, system, watershed, and created_by reference different tables and we
    # want to show 'label' rather than some unintelligible field (like pk 1), have to add
    # slug to tell it to print the desired field from the other table
    created_by = serializers.SlugRelatedField(many=False, read_only=True, slug_field='email')
    feature_fifth_tier = serializers.SlugRelatedField(many=False, read_only=False, slug_field='feature_fifth_tier_slug', queryset=EnvoFeatureFifth.objects.all())
...
class EnvoFeatureSeventhSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'feature_seventh_tier_slug', 'feature_seventh_tier', 'feature_sixth_tier_slug', 'feature_sixth_tier',
                  'feature_fifth_tier_slug', 'feature_fourth_tier_slug', 'feature_third_tier_slug', 'feature_second_tier_slug', 'feature_first_tier_slug', 'envo_identifier', 'ontology_url',
                  'created_by', 'created_datetime', 'modified_datetime', ]
    # Since fund, system, watershed, and created_by reference different tables and we
    # want to show 'label' rather than some unintelligible field (like pk 1), have to add
    # slug to tell it to print the desired field from the other table
    created_by = serializers.SlugRelatedField(many=False, read_only=True, slug_field='email')
    feature_sixth_tier = serializers.SlugRelatedField(many=False, read_only=False, slug_field='feature_sixth_tier_slug', queryset=EnvoFeatureSixth.objects.all())
