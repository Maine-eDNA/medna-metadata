    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('analysis_label', models.CharField('Analysis Label', max_length=255, unique=True)),
                ('process_location', models.ForeignKey(default=utility.models.get_default_process_location, on_delete=django.db.models.deletion.RESTRICT, to='utility.processlocation')),
                ('quality_metadata', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='bioinformatics.qualitymetadata')),
                ('analysis_datetime', models.DateTimeField(verbose_name='Analysis DateTime')),
                ('analyst_first_name', models.CharField(max_length=255, verbose_name='Analyst First Name')),
                ('analyst_last_name', models.CharField(max_length=255, verbose_name='Analyst Last Name')),
                ('denoise_cluster_method', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='bioinformatics.denoiseclustermethod')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('denoise_cluster_metadata', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='bioinformatics.denoiseclustermetadata')),
                ('created_by', models.ForeignKey(default=utility.models.get_default_user, on_delete=models.SET(utility.models.get_sentinel_user), to=settings.AUTH_USER_MODEL)),
                ('modified_datetime', models.DateTimeField(auto_now_add=True, verbose_name='Modified DateTime')),
                ('created_datetime', models.DateTimeField(auto_now=True, verbose_name='Created DateTime')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('feature', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='bioinformatics.featureoutput')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('taxon_domain', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='bioinformatics.taxondomain')),
                ('taxon_url', models.URLField(blank=True, max_length=255, verbose_name='Taxon URL')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('taxon_kingdom', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='bioinformatics.taxonkingdom')),
                ('taxon_url', models.URLField(blank=True, max_length=255, verbose_name='Taxon URL')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('taxon_supergroup', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='bioinformatics.taxonsupergroup')),
                ('taxon_url', models.URLField(blank=True, max_length=255, verbose_name='Taxon URL')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('taxon_phylum_division', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='bioinformatics.taxonphylumdivision')),
                ('taxon_url', models.URLField(blank=True, max_length=255, verbose_name='Taxon URL')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('taxon_class', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='bioinformatics.taxonclass')),
                ('taxon_url', models.URLField(blank=True, max_length=255, verbose_name='Taxon URL')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('taxon_order', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='bioinformatics.taxonorder')),
                ('taxon_url', models.URLField(blank=True, max_length=255, verbose_name='Taxon URL')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('taxon_family', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='bioinformatics.taxonfamily')),
                ('taxon_url', models.URLField(blank=True, max_length=255, verbose_name='Taxon URL')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('taxon_genus', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='bioinformatics.taxongenus')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('analyst_last_name', models.CharField(max_length=255, verbose_name='Analyst Last Name')),
                ('analysis_sop', models.ForeignKey(to='utility.standardoperatingprocedure', on_delete=django.db.models.deletion.RESTRICT, verbose_name='Analysis SOP')),
                ('annotation_method', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='bioinformatics.annotationmethod')),
                ('analysis_script_repo_url', models.URLField(default='https://github.com/Maine-eDNA', max_length=255, verbose_name='Repository URL')),
                ('denoise_cluster_metadata', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='bioinformatics.denoiseclustermetadata')),
                ('process_location', models.ForeignKey(default=utility.models.get_default_process_location, on_delete=django.db.models.deletion.RESTRICT, to='utility.processlocation')),
                ('created_by', models.ForeignKey(default=utility.models.get_default_user, on_delete=models.SET(utility.models.get_sentinel_user), to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('feature', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='bioinformatics.featureoutput')),
                ('annotation_metadata', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='bioinformatics.annotationmetadata')),
                ('reference_database', models.ManyToManyField(related_name='reference_databases', to='bioinformatics.ReferenceDatabase', verbose_name='Reference Databases')),
                ...
                ('manual_domain', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='manual_domain', to='bioinformatics.taxondomain')),
                ('manual_kingdom', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='manual_kingdom', to='bioinformatics.taxonkingdom')),
                ('manual_supergroup', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='manual_supergroup', to='bioinformatics.taxonsupergroup')),
                ('manual_phylum_division', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='manual_phylum_division', to='bioinformatics.taxonphylumdivision')),
                ('manual_class', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='manual_class', to='bioinformatics.taxonclass')),
                ('manual_order', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='manual_order', to='bioinformatics.taxonorder')),
                ('manual_family', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='manual_family', to='bioinformatics.taxonfamily')),
                ('manual_genus', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='manual_genus', to='bioinformatics.taxongenus')),
                ('manual_species', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='manual_species', to='bioinformatics.taxonspecies')),
