...
class EnvoBiomeFirstTestCase(TestCase):
    def setUp(self):
        EnvoBiomeFirst.objects.get_or_create(pk=1, defaults={'biome_first_tier': "Large Lake"})
        EnvoBiomeFirst.objects.get_or_create(pk=2, defaults={'biome_first_tier': "Small River"})
...
class EnvoBiomeSecondTestCase(TestCase):
    def setUp(self):
        ...
        EnvoBiomeSecond.objects.get_or_create(pk=1, defaults={'biome_first_tier': biome, 'biome_second_tier': "test_second_tier"})
...
class EnvoBiomeThirdTestCase(TestCase):
    def setUp(self):
        ...
        EnvoBiomeThird.objects.get_or_create(pk=1, defaults={'biome_second_tier': biome, 'biome_third_tier': "test_third_tier"})
...
class EnvoBiomeFourthTestCase(TestCase):
    def setUp(self):
        ...
        EnvoBiomeFourth.objects.get_or_create(pk=1, defaults={'biome_third_tier': biome, 'biome_fourth_tier': "test_fourth_tier"})
...
class EnvoBiomeFifthTestCase(TestCase):
    def setUp(self):
        ...
        EnvoBiomeFifth.objects.get_or_create(pk=1, defaults={'biome_fourth_tier': biome, 'biome_fifth_tier': "test_fifth_tier"})
...
class EnvoFeatureFirstTestCase(TestCase):
    def setUp(self):
        EnvoFeatureFirst.objects.get_or_create(pk=1, defaults={'feature_first_tier': "Lake Surface"})
        EnvoFeatureFirst.objects.get_or_create(pk=2, defaults={'feature_first_tier': "Turbulent Aquatic Surface Layer"})
...
class EnvoFeatureSecondTestCase(TestCase):
    def setUp(self):
        ...
        EnvoFeatureSecond.objects.get_or_create(pk=1, defaults={'feature_first_tier': feature, 'feature_second_tier': "test_second_tier"})
...
class EnvoFeatureThirdTestCase(TestCase):
    def setUp(self):
        ...
        EnvoFeatureThird.objects.get_or_create(pk=1, defaults={'feature_second_tier': feature, 'feature_third_tier': "test_third_tier"})
...
class EnvoFeatureFourthTestCase(TestCase):
    def setUp(self):
        ...
        EnvoFeatureFourth.objects.get_or_create(pk=1, defaults={'feature_third_tier': feature, 'feature_fourth_tier': "test_fourth_tier"})
...
class EnvoFeatureFifthTestCase(TestCase):
    def setUp(self):
        ...
        EnvoFeatureFifth.objects.get_or_create(pk=1, defaults={'feature_fourth_tier': feature, 'feature_fifth_tier': "test_fifth_tier"})
...
class EnvoFeatureSixthTestCase(TestCase):
    def setUp(self):
        ...
        EnvoFeatureSixth.objects.get_or_create(pk=1, defaults={'feature_fifth_tier': feature, 'feature_sixth_tier': "test_sixth_tier"})
...
class EnvoFeatureSeventhTestCase(TestCase):
    def setUp(self):
        ...
        EnvoFeatureSeventh.objects.get_or_create(pk=1, defaults={'feature_sixth_tier': feature, 'feature_seventh_tier': "test_seventh_tier"})
...
class SystemTestCase(TestCase):
    def setUp(self):
        System.objects.get_or_create(pk=1, defaults={'system_label': "Lake", 'system_code': "L"})
        System.objects.get_or_create(pk=2, defaults={'system_label': "Stream", 'system_code': "S"})
...
class WatershedTestCase(TestCase):
    def setUp(self):
        Watershed.objects.get_or_create(pk=1,
                                        defaults={
                                            'watershed_code': "NE",
