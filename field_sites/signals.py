...
from field_sites.tasks import update_biome_first, update_biome_fourth, update_biome_second, update_biome_third, \
...
from field_sites.models import EnvoBiomeFirst, EnvoFeatureFirst, EnvoFeatureFifth, EnvoFeatureSixth, \
